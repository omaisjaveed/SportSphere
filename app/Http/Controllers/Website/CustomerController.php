...
class CustomerController extends Controller
{
    ...
    public function sign_up(Request $request)
    {
        ...
        if($request->isMethod('get')){
            ...
            $user->favorite_teams = json_encode($request->favorite_teams);
    ...
    public function updateFavoriteTeams(Request $request)
    {
        $request->validate([
            'favorite_teams' => 'array|max:4',
        ...
        return redirect()->back()->with('success', 'Favorite teams updated!');
    }
