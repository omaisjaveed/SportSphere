...
if (!function_exists('bestSelling')) {
	function bestSelling()
	{
		$data = DB::select("SELECT * FROM products WHERE color_code = ''");
		return $data;
	}
}
...
if (!function_exists('get_logo')) {
	function get_logo()
	{
		...
		if ($logo == "") {
			return asset("public/theme/mocksurl/images/site-logo2.png");
		}
...
if (!function_exists('allProducts')) {
	...
	{
		$data = \App\Entity\Product\Product::all();
		return $data;
	}
}
