							...
							<div class="invoice-wrapper">
								...
								<div class="line-items">
										...
										@foreach($order->products as $product)
											<div class="row item">
												...
												<div class="col-md-3 unit_price">
													{!! xss_clean(decimalPlace($order->sub_total, $order->currency)) !!}
												...
												<div class="col-md-3 amount">
													{!! xss_clean(decimalPlace($order->total, $order->currency)) !!}
												</div>
											</div>
										@endforeach
									...
									<div class="total text-right">
										...
										<div class="field">
											{{ _lang('Shipping') }} <span>+
												{!! xss_clean(decimalPlace($order->shipping_cost)) !!}</span>
										</div>
				...
				<form action="{{ action('OrderController@update', $order->id) }}" method="post" id="order-update-form">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control auto-select" data-selected="{{ $order->status }}" name="status"
								required>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<select class="form-control" name="payment_status" id="payment_status" required>
									<option value="pending" {{ $order->getPaymentStatus(false) == 0 ? 'selected' : '' }}>
										{{ _lang('Pending') }}</option>
									<option value="completed" {{ $order->getPaymentStatus(false) == 1 ? 'selected' : '' }}>
