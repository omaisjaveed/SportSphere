...
<!--<li>-->
<!--	<a href="javascript: void(0);"><i class="ti-package"></i><span>{{ _lang('Products') }}</span><span-->
...
<!--<li>-->
<!--	<a href="javascript: void(0);"><i class="ti-comments"></i><span>{{ _lang('Product Discussions') }}</span><span-->
<!--			class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>-->
<!--	<ul class="nav-second-level" aria-expanded="false">-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('product_comments.index') }}">{{ _lang('Comments') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link" href="{{ route('product_reviews.index') }}">{{ _lang('Reviews') }}</a>-->
<!--		</li>-->
<!--	</ul>-->
<!--</li>-->
<!--<li>-->
<!--	<a href="{{ route('service') }}"><i class="ti-menu"></i></i> <span>{{ _lang('Services') }}</span></a>-->
<!--</li>-->
<li>
	<a href="{{ route('admin.posts.index') }}"><i class="ti-menu"></i></i> <span>{{ _lang('Posts') }}</span></a>
</li>
<li>
	<a href="{{ route('teams.index') }}"><i class="ti-menu"></i></i> <span>{{ _lang('Teams') }}</span></a>
</li>
<!--<li>-->
<!--	<a href="{{ route('testimonials.index') }}"><i class="ti-menu"></i> <span>{{ _lang('Testimonials') }}</span></a>-->
<!--</li>-->
...
<!--<li><a href="{{ route('transactions.index') }}"><i class="ti-credit-card"></i>-->
<!--		<span>{{ _lang('Transactions') }}</span></a></li>-->
...
<!--<li><a href="{{ route('navigations.index') }}"><i class="ti-menu"></i> <span>{{ _lang('Site Navigations') }}</span></a>-->
</li>
...
<!--			class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>-->
<!--	<ul class="nav-second-level" aria-expanded="false">-->
<!--		<li class="nav-item"><a class="nav-link" href="{{ route('languages.index') }}">{{ _lang('All Language') }}</a>-->
<!--		</li>-->
...
<li>
	<a href="javascript: void(0);"><i class="ti-desktop"></i><span>{{ _lang('CMS') }}</span><span
			class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
	<ul class="nav-second-level" aria-expanded="false">
		<!-- <li class="nav-item"><a class="nav-link" href="{{ route('theme_option.update','theme_settings') }}">{{ _lang('Theme Settings') }}</a></li> -->
		<li class="nav-item"><a class="nav-link"
				href="{{ route('theme_option.update', 'home_page_settings') }}">{{ _lang('Website Page Settings') }}</a>
		</li>
	</ul>
</li>
...
<!--	<ul class="nav-second-level" aria-expanded="false">-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.order_report') }}">{{ _lang('Order Report') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.sales_report') }}">{{ _lang('Sales Report') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.product_sales_report') }}">{{ _lang('Product Wise Sales') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.product_stock_report') }}">{{ _lang('Product Stock Report') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.coupons_report') }}">{{ _lang('Coupons Report') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link" href="{{ route('reports.tax_report') }}">{{ _lang('Tax Report') }}</a>-->
<!--		</li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.shipping_report') }}">{{ _lang('Shipping Report') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('reports.product_views_report') }}">{{ _lang('Product Views Report') }}</a></li>-->
<!--	</ul>-->
<!--</li>-->
...
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('currency.index') }}">{{ _lang('Currency Manager') }}</a></li>-->
<!--		<li class="nav-item"><a class="nav-link"-->
<!--				href="{{ route('settings.shipping_methods') }}">{{ _lang('Shipping Methods') }}</a></li>-->
